...
RSpec.describe "Sessions", type: :request do 
    ...
    describe "DELETE /logout" do 
        let!(:user) { User.create!(name: "Test", email: "test2@axample.com", password_hash: "password", password_hash_confirmation: "password", phone_number: "1234567890")}
